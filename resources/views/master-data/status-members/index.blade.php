    ...
    <div class="flex items-end justify-between mb-6">
        <div class="space-y-2">
            ...
            <p class="text-gray-500">
                Manage the member statuses in your company
            </p>
        </div>

        <a href="{{ route('status-members.create') }}">
            <x-button-primary>
                Add Member Status
            </x-button-primary>
        </a>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    @forelse($status_members as $status_member)

                        <tr class="border-b border-border">

                            <td class="p-4">

                                {{ $status_members->firstItem() + $loop->index }}

                            </td>

                            <td class="p-4">

                                {{ $status_member->status_name }}
                            ...
                            <td class="p-4">
                                ...
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a
                                        href="{{ route('status-members.edit', $status_member) }}"
                                    ...
                                    <form
                                        action="{{ route('status-members.destroy', $status_member) }}"
                                        method="POST"
