    ...
    <div class="flex items-end justify-between mb-6">
        <div class="space-y-2">
            ...
            <p class="text-gray-500">
                Manage the project statuses in your company
            </p>
        </div>

        <a href="{{ route('status-proyeks.create') }}">
            <x-button-primary>
                Add Project Status
            </x-button-primary>
        </a>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    @forelse($status_proyeks as $status_proyek)

                        <tr class="border-b border-border">

                            <td class="p-4">

                                {{ $status_proyeks->firstItem() + $loop->index }}

                            </td>

                            <td class="p-4">

                                {{ $status_proyek->nama_status }}
                            ...
                            <td class="p-4">
                                ...
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a
                                        href="{{ route('status-proyeks.edit', $status_proyek) }}"
                                    ...
                                    <form
                                        action="{{ route('status-proyeks.destroy', $status_proyek) }}"
                                        method="POST"
